...
PlayerGUI::PlayerGUI()
{
    ...
    for (auto* btn : { &loadButton, &restartButton, &stopButton, &previousButton, &playButton, &pauseButton, &nextButton,&muteButton,&loopButton })
    {
...
void PlayerGUI::buttonClicked(juce::Button* button)
{
    ...
    if (button == &loopButton) {
		bool newLoopState = !playerAudio.getLooping();
